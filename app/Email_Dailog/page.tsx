...
export default function EmailDailogBox(
  {phoneNumber, item, isOpen , onClose}:
  {phoneNumber?:any, item?:any, isOpen?:any , onClose?:any}){
  ...
  // Updated project/src/app/api/Sent_AgencyEmail
 if(selectedValue){
        try {
    ...
    return(
      ...
      {isOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="bg-white w-[500px] h-auto  rounded-lg shadow-md">
          <div className="flex bg-gray-100 shadow-md px-10 rounded-br-full py-4 justify-between items-center mb-4">
           <TbListDetails className="w-6 h-6" />
            <h2 className="text-2xl text-gray-700 font-bold">Contact Agent</h2>
...
<Image src="/logo_app.jpg" layout='fill' alt=''/>
</div>
