...
import { HomeList, PlotList, CommercialList, cities, AreasizeList, Bedrooms, Bathrooms, } from '@/app/GetList'
...
const WrapNewProperties = () => {
  ...
  // console.log("images/list:",uploadedImagesUrls);
  ...
  const [uploadedVideosUrls, setUploadedVideosUrls] = useState([]);
...
var Area_size = Area + ' ' + selectedValue

      const response = await  Add_Property(
        propertyId, userid, selectedOption, activeTab, subType, selectedCity,
        Location, Area_size, price, selectedBedroom, selectedIndex, title,
        description, email, mobile, latitude, longitude, uploadedImagesUrls, 
        uploadedVideosUrls
      )
          if (response.status === 200) {
            // setShowDialog(true)
        ...
        <div className="flex flex-row gap-10 p-4 justify-center  w-[100%]" >
          ...
          <div className="w-[65%]" >
            ...
            <div className="flex flex-grow justify-center gap-4 mb-10">
              <div
                className={`w-[95px] h-10 flex items-center justify-center text-gray-500 rounded-full text-sm border ${selectedOption === 'Sell'
              ...
              <div
                className={`w-[95px] h-10 flex items-center justify-center text-gray-500 rounded-full text-sm border ${selectedOption === 'Rent'
                  ? 'border-blue-700 bg-slate-700 text-white'
                  : 'border-gray-500'
                  } hover:bg-gray-100 hover:border-blue-700 hover:text-blue-500 cursor-pointer transition duration-400`}
            ...
            <div className=" mt-[20px]  mx-4  h-[auto] my-4">
              <div className="flex space-x-8 border-b-2">
                {['Home', 'Plots', 'Commercials'].map((tab, index) => (
                  <div
                    key={index}
                    className={`cursor-pointer  text-black ${activeTab === tab
                ...
                {activeTab === 'Home' && (
                  <div className="grid grid-cols-3 gap-4">
                    {HomeList.map((item, index) => (
                      <div
                        key={index}
                        className={`h-10 flex items-center justify-center gap-2 text-gray-500 rounded-full text-xs border ${subType === item.text
            ...
            <div className="grid grid-cols-10 gap-4 mt-2">
              {Bedrooms.map((item, index) => (
                <div
                  ...
                  className={`text-black rounded-full flex items-center justify-center text-xs p-2 border ${selectedBedroom === item
                    ? 'border-blue-700 bg-slate-700 text-white'
                    : "border-gray-700"
            ...
            <div className="grid grid-cols-10 gap-4 mt-2">
              {Bathrooms.map((item, index) => (
                <div
                  ...
                  className={`p-2 text-black rounded-full flex items-center justify-center text-sm border ${selectedIndex === index
                    ? 'border-blue-700 bg-slate-700 text-white'
         ...
         Upload Image
            ...
            <div className="border-dotted border-2 border-gray-500 p-4 rounded-lg mt-2">
              ...
              {/* <div className="mt-4 flex flex-wrap gap-6 ">
                ...
                {uploadedVideosUrls.map((videoUrl, index) => (
