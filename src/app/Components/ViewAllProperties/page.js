...
const PurposeList = ['Sell' , 'Rent']
  ...
  return (
   ...
   <div className="bg-slate-100 min-h-full " >
      ...
      <div
        className="w-[1010px] mt-[90px]  ml-[140px] opacity-120 bg-black  "
      >
...
<div className="flex ">
        ...
        <div className="px-5 py-4 flex gap-1">
              <div className="group inline-block relative">
                ...
                {ispurposeDropdownOpen && ( // Render the dropdown only if isDropdownOpen is true
                  <ul className="bg-white border shadow-lg rounded-sm ml-2 absolute w-full  h-auto custom-scrollbar">
            ...
            <div className="px-5 py-4 flex gap-1">
              <div className="group inline-block relative">
                ...
                {iscityDropdownOpen && ( // Render the dropdown only if isDropdownOpen is true
                  <ul className="bg-white border shadow-lg rounded-sm  transform overflow-y-auto scale-100 absolute transition duration-150 ease-in-out origin-top min-w-32 h-64 custom-scrollbar">
                ...
                <div className="w-[530px] ">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      id="search"
                      className="block w-full h-[64px] rounded-sm font-sans p-5 pl-10 text-sm text-gray-900 border border-gray-300   bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-blue-700 dark:border-blue-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      placeholder="Search"
                      required
                    />
                  </div>
        ...
        <div className="bg-black ml-3   dark:bg-neutral-800">
          <div
            id="collapseTwo5"
                ...
                <div className="group inline-block relative">
                  ...
                  <div className="bg-white border  shadow-lg rounded-sm  transform overflow-hidden scale-0 group-hover:scale-100 absolute transition duration-150 ease-in-out origin-top w-[262px] h-64 custom-scrollbar">
                    ...
                    <div className="flex flex-row  max-w-md mx-auto gap-2 px-2 p-2">
                      <div className="h-[300px] w-[125px] border border-gray-400 overflow-y-auto custom-scrollbar">
                        <ul className="">
                          {MIN.map((value, index) => (
                            <li
                              key={index}
                      ...
                      <div className="h-[300px] w-[125px] overflow-y-auto border border-gray-400 custom-scrollbar">
                        <ul className="">
                          {MAX.map((value, index) => (
                            <li
                              key={index}
...
function GotToNextPage(item){
  ...
  return (
    <div className="container h-screen mx-auto mt-16 mb-10 p-4">
      {isLoading ? (
        <LoadingSpinner />
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 ">
          {images.length === 0 ? (
            <div className="absolute left-[540px] mt-[30px]" >
  <div className="flex justify-center flex-col items-center w-full m-auto">
              {/* <img
                src="/not.jpg" // Replace with your image path
                alt="Search Not Found"
                className="w-40 h-40 mb-6 rounded-full border-4 border-indigo-500 shadow-lg"
              /> */}
              <p className="text-2xl font-semibold text-indigo-600">Oops! Search Not Found</p>
            ...
            images.map((item) => (
              <div key={item._id} className="bg-white w-9/12 rounded-lg overflow-hidden shadow-md">
                ...
                <div className="cursor-pointer"  onClick={() => GotToNextPage(item) } >
